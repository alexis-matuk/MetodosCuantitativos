...
double getPk(double lambda, double miu, double k)
{
    return pow((lambda/miu),k+1);
}
...
{ 
    ...
    std::cout << "Pn>k: " << Pk << std::endl;
    std::cout << "Probability of more than k units in the system" << std::endl;     
